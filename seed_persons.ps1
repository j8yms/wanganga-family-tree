$apiUrl = "https://script.google.com/macros/s/AKfycbxxgjND3ex5xTp3eUV8uCX6XAwtWax4EZ2tHpeOcVx80tZMx7IMXLyWFzZ7qfRBK0gEqA/exec"
...
$persons = @(
    ...
    @{ gikuyu_name="Thiongo"; fathers_name="Kamau"; other_names="Daniel"; gender="Male"; is_living=$true; birth_year="1970" },
    @{ gikuyu_name="Wanjiku2"; fathers_name="Thiongo"; other_names="Sarah"; gender="Female"; is_living=$true; birth_year="1975" },
    @{ gikuyu_name="Maina"; fathers_name="Thiongo"; other_names="David"; gender="Male"; is_living=$true; birth_year="1972" },
    ...
    @{ gikuyu_name="Githinji"; fathers_name="Wanjiku2"; other_names="Brian"; gender="Male"; is_living=$true; birth_year="1998" },
    @{ gikuyu_name="Mumbi"; fathers_name="Wanjiku2"; other_names="Alice"; gender="Female"; is_living=$true; birth_year="2001" }
)
...
$ids | ConvertTo-Json | Out-File -FilePath "D:\VIBE CODING\Family tree\person_ids.json" -Encoding UTF8
Write-Host "`nIDs saved to person_ids.json"
